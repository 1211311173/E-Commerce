  ...
  <div class="row" style="gap: 25px">
    <div class="col d-flex justify-content-center">
      ...
      <div class="card" style="width: 18rem">
          ...
          <div class="profile_edit">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-12">
                  <input type="text" name="name" id="" class="form-control" placeholder="New Name..." />
                </div>
              </div>
              <div class="row mb-3">
        ...
        > -->
                <div class="col-sm-12">
                  <input type="email" name="email" id="" class="form-control" placeholder="New Eamil..." />
                </div>
          ...
          if ($_SESSION['customer_role'] == 'admin') {
            ?>
            <a id='admin' href='admin/login.php' class="btn btn-primary">
              Visit Admin Panel
            </a>
    ...
    <div class="col d-flex justify-content-center">
      ...
      <div class="card" style="width: 18rem">
        <div class="card-body">
          ...
          <a href="#/address/edit" id="edit_link2" class="btn btn-primary">
            Edit
          </a>
          ...
          <div class="address_edit ">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
              ...
              <div class="row mb-3">
                <!-- <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label> -->
                <div class="col-sm-12">
                  <input type="text" name="address" id="" class="form-control" placeholder="New Address..." />
                </div>
              </div>
              <div class="row mb-3">
                <!-- Save button -->
    ...
    <div class="col d-flex justify-content-center">
      ...
      <div class="card" style="width: 18rem">
        <div class="card-body">
          ...
          <a href="#/contact/edit" id="edit_link3" class="btn btn-primary">
            Edit
          </a>
          ...
          <div class="contact_edit ">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
              ...
              <div class="row mb-3">
                <!-- <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label> -->
                <div class="col-sm-12">
                  <input type="number" name="number" id="" class="form-control" placeholder="New Number..." />
                </div>
              </div>
              <div class="row mb-3">
                <!-- Save button -->
